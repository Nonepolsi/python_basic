...
urlpatterns = [
    ...
    path('user/<slug:user_slug>/', views.UserDetailView.as_view(), name="user"),
    path('results/', views.ResultListView.as_view(), name="results"),
    path('result/<slug:result_slug>/', views.ResultDetailView.as_view(), name="result"),
    path('quiz_list/', views.QuizListView.as_view(), name="quiz_list"),
    path('quiz/<slug:quiz_slug>/', views.QuizDetailView.as_view(), name="quiz"),
